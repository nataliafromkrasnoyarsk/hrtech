...
## Russian Regulatory Content Standards / Стандарты для регуляторного контента

### Обязательные правила для статей о законодательстве, отчетности, штрафах

**Орфография и стиль:**
- Использовать **"е" вместо "ё"** последовательно во всем тексте (веб-стандарт)
- Ссылки на законы: **"ч. X ст. Y закона № Z-ФЗ"** — единый формат
- Профессиональный регистр: "кадровый специалист" в заголовках, "кадровик" допустим в тексте

**Антипаттерны (избегать):**
- ❌ Разговорные обороты: "голова идет кругом", "без воды", "а можно было просто..."
- ❌ Метакомментарии: "В этой статье мы расскажем все, что нужно знать"
- ❌ Оглавление внутри статьи (навигацию обеспечивает CMS)
- ❌ Плоские чек-листы без категоризации
- ❌ Таблицы штрафов без колонки "Основание" (ссылка на закон)
- ❌ Перечисление каждого инструмента как отдельного способа подачи

**Обязательные элементы:**
- ✅ Экспертная цитата (имя, должность, компания) — в первой трети статьи
- ✅ Единая сводная таблица сроков с датами вперед (следующий год)
- ✅ Колонка "Основание" в таблицах штрафов
- ✅ Раздел "Что делать, если..." (troubleshooting) с пошаговыми инструкциями
- ✅ Разделение изменений: "Что убрали / Что добавили / Что скорректировали"
- ✅ Категоризированный чек-лист (Техника, Организация, Контроль)
- ✅ CTA-блоки, встроенные между разделами (не только в конце)
- ✅ Оговорки в FAQ ("скидка действует только для раздела 1")
